...
class PushLeft extends BaseScenario
{

    protected $_name = 'toImage pushes fromImage to the left';
    ...
    public function frames( ImageManager $imageManager, Config $config, $fromImage, $toImage, $width, $height )
    {
        ...
        while( $counter > 0 ){
            ...
            $img->insert( $previous, 'top-left', $counter - $width );
            $img->insert( $result, 'top-left', $counter );
